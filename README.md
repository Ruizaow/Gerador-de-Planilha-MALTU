Script em Python que extrai comentários de avaliação de usuários de uma página de aplicativo para gerar uma tabela com basae no modelo de avaliação MALTU de Interação Humano-Computador.
